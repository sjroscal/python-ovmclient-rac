...
class RepositoryManager(base.BaseManager):
    ...
    def importVm(self, id, data, create_template=True):
        params = {
            "createTemplate": create_template,
        }

        return self._actionforimport(id, "importVm", data, params=params)
...
class VmManager(base.BaseManager):
    ...
    # modified by jrshin
    def get_virtualnic_url(self, id):
        return self._get_resource(id, "VirtualNic/id")
